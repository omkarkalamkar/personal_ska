...
""" Device Data:
This module defines the DeviceData class,
which represents of the functional DishLeafNode device."""
...
class DeviceData:
    ...
    def _load_config_string(self, argin):
        ...
        try:
            ...
            raise Exception(
                f"Invalid JSON format.'{jsonerr}'in \
                    device_data._load_config_string."
            )
