...
def test_off_command_in_lp(tango_context, dish_master_device):
...
def test_off_command_in_fp(tango_context, dish_master_device, task_callback, group_callback):
    ...
    group_callback["dishMode"].assert_change_event(DishMode.STANDBY_FP, lookahead=4)
