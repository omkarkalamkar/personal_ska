...
def test_setstandbylpmode_command(tango_context, cm, task_callback):
...
def test_setstandbylpmode_command_adapter_none(cm, task_callback):
    cm.update_device_dish_mode(DishMode.STANDBY_FP)
    assert cm.is_setstandbylpmode_allowed()
...
def test_setstandbylpmode_command_not_allowed(tango_context, cm):
