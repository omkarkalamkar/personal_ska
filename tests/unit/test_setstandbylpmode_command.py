...
def test_setstandbylpmode_command(tango_context, dish_master_device, task_callback):
...
def test_setstandbylpmode_command_adapter_none(dish_master_device, task_callback):
    cm = create_cm(dish_master_device)
    cm.update_device_dish_mode(DishMode.STANDBY_FP)
    assert cm.is_setstandbylpmode_allowed()
...
def test_setstandbylpmode_command_not_allowed(tango_context, dish_master_device):
    cm = create_cm(dish_master_device)
