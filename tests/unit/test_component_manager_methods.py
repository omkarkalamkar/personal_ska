...
class TestStopExecutorsAndCleanupMemory:
    """Test cases for stop_executors_and_cleanup_memory method"""

    def test_stop_executors_with_event_receiver(self, cm_without_er_lp):
    ...
    def test_stop_executors_without_event_receiver(self, cm_without_er_lp):
    ...
    def test_stop_executors_when_process_not_alive(self, cm_without_er_lp):
    ...
    @mock.patch("os.kill")
    def test_stop_executors_with_force_kill(self, mock_kill, cm_without_er_lp):
...
class TestProcessActualPointing:
    """Test cases for process_actual_pointing method"""

    def test_process_actual_pointing_basic_operation(self, cm):
        """Test basic operation of process_actual_pointing"""
        # cm fixture already has process running
        assert cm.actual_pointing_process.is_alive()

    def test_process_actual_pointing_with_data(self, cm):
    ...
    def test_process_actual_pointing_handles_empty_queue(self, cm):
    ...
    def test_process_actual_pointing_handles_layout_update(self, cm):
    ...
    def test_process_actual_pointing_stops_on_event(self, cm_without_er_lp):
    ...
    def test_process_actual_pointing_handles_invalid_data(self, cm):
