...
def test_setstandbyfpmode_command_with_failed_dishmaster(
    tango_context, dish_master_device
):
    cm, set_standby_fp_mode_command, _ = get_dishln_command_obj(
        SetStandbyFPMode
    )
    ...
    with pytest.raises(
        ...
        set_standby_fp_mode_command.check_allowed()
