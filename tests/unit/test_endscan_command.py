...
def test_endscan_command(tango_context, cm_without_er_lp, task_callback):
    cm = cm_without_er_lp
    ...
    simulate_result_code_event(cm, "EndScan", ResultCode.OK)
    task_callback.assert_against_call(
        call_kwargs={
...
def test_endscan_mode_command_not_allowed(cm):
